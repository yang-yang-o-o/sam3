...
from _paths import SAM31_CHECKPOINT, SAM3_ROOT

sam3_root = SAM3_ROOT
from sam3.model_builder import build_sam3_multiplex_video_predictor

# use_fa3 defaults to auto (off on V100/Volta; on for Ampere+). Force with use_fa3=False/True.
predictor = build_sam3_multiplex_video_predictor(checkpoint_path=SAM31_CHECKPOINT)
